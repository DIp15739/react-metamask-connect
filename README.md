Today we're we are building the "account login" button that allows users to connect to a Dapp using their MetaMask extension.

repo uses the following tech:
